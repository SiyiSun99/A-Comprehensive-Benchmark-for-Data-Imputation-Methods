...
if __name__ == '__main__':
    ...
    for m_m in tqdm(missing_mechanism):
        for m_r in tqdm(missing_ratio):
            folder_path = '/data/coml-data-imputation/shug7754/data_stored/data_dsan/{}/Case{}/{}'.format(m_m, casenum, m_r)
            ...
            for smp in tqdm(range(10)):
                ...
                res_csv_path = '/data/coml-data-imputation/shug7754/data_stored/data_dsan/{}/Case{}/{}/{}.csv'.format(m_m, casenum, m_r, smp)
